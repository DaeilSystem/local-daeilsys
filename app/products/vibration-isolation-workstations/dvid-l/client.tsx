...
import productData from "@/data/products/dvid-l-full.json"
...
export default function DvidLClient() {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td colSpan={2} className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
                        {productData.tabs.specifications.workspaceType.construction.topPlate}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
                        {language === "en" ? "Workspace" : "작업 공간"}
                      </td>
                      <td colSpan={2} className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
                        {productData.tabs.specifications.workspaceType.construction.workspace}
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td colSpan={2} className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
                        {productData.tabs.specifications.armrestType.construction.topPlate}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
        ...
        {activeTab === "options" && (
          <div className="space-y-12">
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white text-center">
              {typeof productData.tabs.options.title === "string"
                ? productData.tabs.options.title
                : productData.tabs.options.title[language]}
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              {productData.tabs.options.items.map((option, index) => (
                <div key={index} className="space-y-4">
