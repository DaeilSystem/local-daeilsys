...
export default function DVIFClient() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {activeTab === "overview" && (
          <div className="space-y-12">
            ...
            {/* Structure Image */}
            {productData.tabs.overview.structureImage && (
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">
                  {language === "en" ? "Vibration Isolated Foundation Structure" : "독립기초제진대 구조"}
                </h3>
                <div className="max-w-4xl mx-auto">
                  <div className="rounded-lg overflow-hidden shadow-lg dark:shadow-xl">
                    <img
                      src={productData.tabs.overview.structureImage}
                      alt={language === "en" ? "Vibration Isolated Foundation Structure" : "독립기초제진대 구조"}
