...
export default function DvimMClient() {
          ...
          <div className="space-y-12">
            ...
            {productData.tabs.order.image && (
              <div className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="DVIM-M Ordering Information"
            ...
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">
                {language === "en" ? "Standard Model Specifications" : "표준 모델 사양"}
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    {productData.tabs.order.standardModels.map((model, index) => (
                      <tr key={index}>
            ...
            <div className="mt-12">
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">
                {language === "en" ? "Model with Built-in Oil Damper Specifications" : "내장형 오일 댐퍼 모델 사양"}
              </h3>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    {productData.tabs.order.damperModels.map((model, index) => (
                      <tr key={index}>
                        <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700">
                          {model.modelNo}
                        </td>
