...
export default function OpticalBreadboardsClient() {
                ...
                <div className="text-center space-y-4">
                  <div>
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white">
                      {productData.tabs.performance.data[language].model}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-semibold text-blue-600 dark:text-blue-400">
                      {productData.tabs.performance.data[language].resonantFrequency}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-semibold text-blue-600 dark:text-blue-400">
                      {productData.tabs.performance.data[language].compliance}
                    </span>
                  </div>
                </div>
              </div>
