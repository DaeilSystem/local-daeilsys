...
import productData from "@/data/products/clean-booth-full.json"
import { useLanguage } from "@/hooks/use-language"
import Link from "next/link"
import { useState } from "react"

type TabType = "overview" | "features" | "specifications" | "resources"

export default function CleanBoothClient() {
                    ...
                    >
                      {row.map((cell, cellIndex) => (
                        <td
                          ...
                          colSpan={row.length === 1 && rowIndex === 0 ? (productData.tabs.specifications.rows[0]?.length || 3) : 1}
                        >
                          {cell || ""}
                        </td>
                      ))}
