...
type TabType = "overview" | "features" | "performance" | "specifications" | "options" | "resources"

export default function NonMagneticClient() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {activeTab === "performance" && (
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {/* Performance Note */}
            {productData.tabs.performance.note && (
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center italic">
                {typeof productData.tabs.performance.note === "string"
                  ? productData.tabs.performance.note
                  : productData.tabs.performance.note[language]}
              </p>
            )}
          </div>
        )}
