            ...
            <div>
              ...
              <p className="text-xl text-blue-600 dark:text-blue-400 font-medium mb-2">
                {isInitialized && language === "ko"
                  ? "고급 액티브 제진 시스템"
                  : "Advanced Active Vibration Isolation System"
                }
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                {isInitialized && language === "ko"
                  ? "고정밀 애플리케이션을 위한 고급 액티브 제진 시스템입니다."
                  : "Advanced active vibration isolation system for high-precision applications."
                }
              </p>
            </div>
