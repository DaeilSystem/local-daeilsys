  ...
  return (
    <div className="pa-homepage pa-dark">
      ...
      >
        ...
        <div className="container pa-hero-content text-center" style={{ marginTop: "6vh" }}>
          ...
          <div className="row" style={{ marginTop: "20px" }}>
            <div className="col-12" style={{ maxWidth: "976px", margin: "0 auto" }}>
        ...
        <div className="breadcrumbs">
          <ol itemScope itemType="https://schema.org/BreadcrumbList">
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <a itemProp="item" target="_self" href={isKorean ? "/ko/" : "/"}>
                <span itemProp="name">HOME</span>
              </a>
              <meta itemProp="position" content="1" />
            </li>
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <a itemProp="item" target="_self" href={isKorean ? "/ko/products/" : "/products/"}>
                <span itemProp="name">{isKorean ? "제품소개" : "Products"}</span>
              </a>
              <meta itemProp="position" content="2" />
            </li>
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <a itemProp="item" target="_self" href={isKorean ? "/ko/products/active-vibration-isolation-systems/" : "/products/active-vibration-isolation-systems/"}>
                <span itemProp="name">{isKorean ? "액티브 제진대" : "Active Vibration Isolation Systems"}</span>
              </a>
              <meta itemProp="position" content="3" />
            </li>
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <span itemProp="name">{isKorean ? "DVIA-MLP 커스텀 액티브 제진대" : "DVIA-MLP Custom Active Vibration Isolation System"}</span>
      ...
      >
        <div className="container">
          ...
          <div className="row icon-list-wrap">
      ...
      <section id="portfolio" className="pa-portfolio four-feat-sec">
        ...
        <div className="container-fluid">
          <div className="row pa-row-max2560">
            <div className="col-12 col-xl-3 col-sm-6 col-lg-6 p-0">
              <div
            ...
            <div className="col-12 col-xl-3 col-sm-6 col-lg-6 p-0 four-feat-sec-text">
              ...
              <div className="pa-portfolio-thumb-centered-content w-100">
        ...
        <section className="black-bg six-degree-sec">
          <div className="container text-center">
            <div className="row">
              ...
              <div className="all-six-degrees-img col-12 col-xl-12 text-center fadeIn wow" data-wow-duration="1s" data-wow-delay="0.4s">
                <img
          ...
          <div className="container text-center viewer">
            <div className="row justify-content-center">
              <div className="brochure-text col-12 mb-3">
                <p className="bro-txt-title fadeInUp wow" data-wow-duration="1s" data-wow-delay="0.2s">
                  DVIA-MLP2000 (Standard) 3D Modeling
                </p>
              </div>

              <div className="col-12 fadeIn wow" data-wow-duration="1s" data-wow-delay="0.4s">
