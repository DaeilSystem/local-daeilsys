    ...
    <div className={`w-full ${className}`}>
          ...
          {stories.map((story, index) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-xl sm:rounded-2xl">
                ...
                <Button
                  size="sm"
                  className="absolute top-3 right-3 sm:top-4 sm:right-4 rounded-full w-7 h-7 sm:w-8 sm:h-8 p-0 bg-white/20 hover:bg-white/30 border border-white/30 backdrop-blur-sm text-white hover:text-white"
                  onClick={(e) => {
                    e.stopPropagation()
      ...
      <div className="flex justify-center items-center mt-6 sm:mt-8 gap-3 sm:gap-4">
        ...
        <Button
          variant="outline"
          size="sm"
          className="rounded-full w-8 h-8 sm:w-10 sm:h-10 p-0 bg-white border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200"
        >
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <Button
            ...
            className="rounded-full w-7 h-7 sm:w-8 sm:h-8 p-0 disabled:opacity-30 border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200"
          >
